...
public abstract class EJBContainer {
    ...
    public static synchronized EJBContainer createEJBContainer(java.util.Map<?, ?> properties) {
        return new no.knowit.openejb.OpenEjbContainer.Provider().createEJBContainer(properties);
    }
