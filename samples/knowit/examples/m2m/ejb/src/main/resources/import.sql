...
insert into Company(id, version, uuid, name) values (1, 0, '21', 'KnowIt')
insert into Company(id, version, uuid, name) values (2, 0, '22', 'LogIt')
insert into Company(id, version, uuid, name) values (3, 0, '23', 'PT')
insert into Company(id, version, uuid, name) values (4, 0, '24', 'Red Hat')
