...
== How to install and run the application: ==
  ...
  * [http://seam-maven-refimpl.googlecode.com/svn/trunk/samples Export the samples folder from svn]
  * Open a command shell and cd to the samples folder: samples
  * Execute *mvn install* to install the root pom (the samples root pom is not in any repo yet, so you have to install it)
  ...
  * Also read the *readme.txt* from the original JBoss Seam example
