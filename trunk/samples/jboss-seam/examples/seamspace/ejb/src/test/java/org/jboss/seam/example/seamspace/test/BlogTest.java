...
public class BlogTest extends SeamOpenEjbTest
{   
  private static final LogProvider log = Logging.getLogProvider(BlogTest.class);
...
//    contextProperties.put("log4j.category.org.jboss.seam.mock", "DEBUG");
   ...
   public void testCreateComment() throws Exception
   {
      ...
      String cid = new FacesRequest("/comment.xhtml")
      {
         ...
         {
              assert getValue("#{selectedBlog}") != null : "Blog was null!";
