...
public final class OpenEjbContainer extends EJBContainer {
  ...
  private static final String LOCAL_INITIAL_CONTEXT_FACTORY =
  ...
  private OpenEjbContainer(final Context context) {
  ...
  public static class Provider implements EJBContainerProvider {
    ...
    @Override
    public synchronized EJBContainer createEJBContainer(final Map<?, ?> properties) {
      if (container == null) {
    ...
    private EJBContainer createContainer(final Map<?, ?> properties) {
