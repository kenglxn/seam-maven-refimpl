package no.knowit.openejbtest.seam.seamframework;

import java.util.List;

import no.knowit.crud.CrudService;
import no.knowit.openejbtest.model.Movie;
import no.knowit.openejbtest.seam.seamframework.MovieHome;
import no.knowit.openejbtest.seam.seamframework.MovieList;
